...
(* 基于斯科特[1] *)
(* 消除了哥德尔原始版本中公理不一致的问题 *)
(* 斯科特本人的版本[1]基于S5系统，但最近的研究[6]显示只需更弱的KB系统 *)
...
Lemma 神性的一切后果都存在实例 : ⌈∀ Φ, (∀ x, 神性 x → Φ x) → ∃ x : 实体, Φ x⌋.
Proof.
  证明. intros Φ H.
...
Proof.
  ...
  eapply 必然性三段论. apply H. apply 𝗡. 证明.
  apply 神性的一切后果都存在实例.
Qed.
